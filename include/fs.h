...
struct File {
	...
	u_int f_type;			// file type, contaning regular file (FTYPE_REG) and directory file (FTYPE_DIR)
	u_int f_direct[NDIRECT];	//support visit towards (<=)40KB file
	u_int f_indirect;			//(>)40KB file
